...
public class AESUtils {
    ...
    public static void main(String[] args) throws Exception {
        byte[] encrypted = AESUtils.encrypt("{\"title\":\"title\",\"body\":\"这是一条消息这是一条21312\",\"srcPack\":\"cn.soulapp.android\",\"time\":\"2021-01-19 17:37:09\"}".getBytes("UTF-8"), "1234654".getBytes("UTF-8"));
